...
require (
	...
	github.com/brickKit/mdm-customer/gen/mdm/customer v0.0.0
...
// gen/mdm/customer 是本仓库自己嵌套的 go module（不是外部依赖）——理由与 module
...
// 以字面量 `/v1` 结尾。
replace github.com/brickKit/mdm-customer/gen/mdm/customer => ./gen/mdm/customer
